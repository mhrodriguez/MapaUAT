...
<html>
  <head>
    <meta charset="utf-8">
    <title>Vista Informacion Cobertura</title>
      ...
      $(document).ready(function(){
          $('#InfoTerritorios').DataTable();
			...
			function Eliminar(id){
				...
				text: "Cuando se elimina una Cobertura se pierden todos los datos almacenados!",
				type: 'warning',
				showCancelButton: true,
				confirmButtonColor: '#3085d6',
				cancelButtonColor: '#d33',
				cancelButtonText:'Cancelar',
				confirmButtonText: 'Si, Eliminar Cobertura!'}).then(function() {
			...
			function Procesar_Eliminar(id){
				...
				$.ajax({
					type:'POST',
					url:"procesar_EliminarCobe.php",
					data: {opcion:opcion,id:id},
					success:function(respuesta){
						swal('Cobertura Eliminada!',
							'La Cobertura fue eliminada exitosamente.',
                ...
                <div class="content-row">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading" style="background-color: #A96317;">
                      <div class="panel-title" style="color:white; text-align: center; font-size: 20px"><b>Listado de Coberturas</b>
                      </div>
                    ...
                    <div class="panel-body">
                          <div class="table-responsive">
                            <table class="table display table table-striped table-bordered datatable" id="InfoTerritorios" cellspacing="0" width="100%">
                              <thead>
                                <tr>
                                  <th style=" text-align: center; ">Id Cobertura</th>
                              ...
                              <tbody>
                                  ...
                                  foreach ($ConexionBD -> query($select) as $resultado){//imprime los valores 
                                    ...
                                    echo "<td style=' text-align: center; '><img src='../../mapa/".$resultado["rutaMarcador"]."'height='44' width='32'></img></td>";
                                    echo "<td style=' text-align: center; '>"."<a href='EditarCobe.php?id=$resultado[id]'><button class='btn btn-success ' border: none;'>Editar</button></a>"."</td>";
