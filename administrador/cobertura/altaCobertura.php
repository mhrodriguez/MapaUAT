                ...
                <div class="content-row">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading" style="background-color: #A96317;">
                      <div class="panel-title" style="color:white; text-align: center; font-size: 20px"><b>Alta de Cobertura</b>
                      </div>
                    ...
                    <div class="panel-body">
                      <form action="procesar_AltaCobertura.php" method="POST" enctype="multipart/form-data" role="form" class="form-horizontal">
                        <div class="form-group">
                          <label class="col-md-2 control-label" style="font-size: 14px">Nombre:</label>
                          <div class="col-md-10">
                            <input type="text" required placeholder="Nombre de la Cobertura" id="nombreC" class="form-control" name="nombreC">
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <div class="col-md-offset-2 col-md-10">
                            <button class="btn btn-success" type="submit">Registrar Cobertura</button>
                          </div>
                        </div>
                      </form>
                    </div>
