<?php
  ...
  session_start();
	...
	if(isset($_POST['Asignacion'])){
		...
		$IdAreaCon = $_POST['idAre'];
	
		$ConexionBD = new Conexion();
		$InsertPA = $ConexionBD -> prepare("INSERT INTO PROYECTO_AREA (idProyecto, idArea) VALUES ('$IdProyecto','$IdAreaCon')");
		$SelectChecarArea = $ConexionBD -> prepare("SELECT * FROM PROYECTO_AREA WHERE idProyecto = '$IdProyecto' AND idArea = '$IdAreaCon'");
		$SelectChecarArea->execute();
		
		if($Datos = $SelectChecarArea -> fetch()){
      	echo "<script>";
	  		echo "alert('EL PROYECTO YA TIENE ASIGNADA ESA AREA DE CONOCIMIENTO!!');";
	  		echo "window.location = 'AsignacionProyectoArea.php';";
	  		echo "</script>";
    }
		else{
			if($InsertPA->execute()==TRUE){
				echo "<script>";
                ...
                <div class="content-row">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading" style="background-color: #A96317;">
                      <div class="panel-title" style="color:white; text-align: center; font-size: 20px"><b>Asingacion de Proyecto - Area</b>
                      </div>
                    ...
                    <div class="panel-body">
                          ...
                          <div class="col-md-10">
                            <select class="form-control js-example-responsive" name="idAre" id="idAre" style="width: 100%">
                              <option>Selecciona el Area de Conocimiento Perteneciente</option>
                              <?php
                                $ConexionBD = new Conexion();
                          ...
                          <div class="col-md-offset-2 col-md-10">
                            <button class="btn btn-success" type="submit" id="Asignacion" name="Asignacion">Registrar Asignacion Proyecto - Area</button>
                          </div>
                        </div>
											</form>
                    </div>
