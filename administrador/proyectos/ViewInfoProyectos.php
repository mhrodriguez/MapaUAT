      ...
      $(document).ready(function(){
          $('#InfoTerritorios').DataTable();
			...
			function Eliminar(id){
				...
				text: "Cuando se elimina un Proyecto se pierden todos los datos almacenados!",
				type: 'warning',
				showCancelButton: true,
				confirmButtonColor: '#3085d6',
				cancelButtonColor: '#d33',
				cancelButtonText:'Cancelar',
				confirmButtonText: 'Si, eliminar Proyecto!'}).then(function() {
			...
			function Procesar_Eliminar(id){
				...
				$.ajax({
					type:'POST',
					url:"procesar_EliminarProyecto.php",
					data: {opcion:opcion,id:id},
					success:function(respuesta){
						swal('Proyecto Eliminado!',
							'El Proyecto fue eliminada exitosamente.',
                ...
                <div class="content-row">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading" style="background-color: #A96317;">
                      <div class="panel-title" style="color:white; text-align: center; font-size: 20px"><b>Listado de Proyectos</b>
                      </div>
                    ...
                    <div class="panel-body">
                          <div class="table-responsive">
                            <table class="table display table table-striped table-bordered datatable" id="InfoTerritorios" cellspacing="0" width="100%">
                              <thead>
                                <tr>
                                  <th style=" text-align: center; ">Num. Proyecto</th>
                                  <th style=" text-align: center; ">Titulo</th>
                                  <th style=" text-align: center; ">Año Inicio</th>
                                  <th style=" text-align: center; ">Año Fin</th>
                                  <th style=" text-align: center; ">Monto Autorizado</th>
																	<th style=" text-align: center; ">Monto Empresa</th>
                                  <th style=" text-align: center; ">Monto Externo</th>
                              ...
                              <tbody>
                                  ...
                                  foreach ($ConexionBD -> query($select) as $resultado){//imprime los valores 
                                    ...
                                    echo "<td style=' text-align: center; '>".$resultado["anioInicio"]."</td>";
                                    echo "<td style=' text-align: center; '>".$resultado["anioFin"]."</td>";
                                    echo "<td style=' text-align: center; '>".$resultado["montoUATAutorizado"]."</td>";
                                    echo "<td style=' text-align: center; '>".$resultado["montoEmpresa"]."</td>";
                                    echo "<td style=' text-align: center; '>".$resultado["montoExterno"]."</td>";
                                    echo "<td style=' text-align: center; '>"."<a href='EditarProyecto.php?id=$resultado[Id]'><button class='btn btn-success ' border: none;'>Editar</button></a>"."</td>";
