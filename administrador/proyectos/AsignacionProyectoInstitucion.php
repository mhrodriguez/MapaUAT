<?php
  ...
  session_start();
	...
	if(isset($_POST['Asignacion'])){
		...
		$idInstitucion = $_POST['idInst'];
	
		$ConexionBD = new Conexion();
		$InsertPI = $ConexionBD -> prepare("INSERT INTO INSTITUCIONES_PARTICIPANTES (idProyecto, IdInstitucion) VALUES ('$IdProyecto','$idInstitucion')");
		$SelectChecar = $ConexionBD -> prepare("SELECT * FROM INSTITUCIONES_PARTICIPANTES WHERE idProyecto = '$IdProyecto' AND IdInstitucion = '$idInstitucion'");
		$SelectChecar->execute();
		
		if($Datos = $SelectChecar -> fetch()){
      	echo "<script>";
	  		echo "alert('EL PROYECTO YA TIENE ASIGNADA ESA INSTITUCION!!');";
	  		echo "window.location = 'AsignacionProyectoInstitucion.php';";
	  		echo "</script>";
    }
		else{
			if($InsertPI->execute()==TRUE){
				echo "<script>";
                ...
                <div class="content-row">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading" style="background-color: #A96317;">
                      <div class="panel-title" style="color:white; text-align: center; font-size: 20px"><b>Asingnación de Proyecto - Institución</b>
                      </div>
                    ...
                    <div class="panel-body">
                          ...
                          <div class="col-md-10">
                            <select class="form-control js-example-responsive" name="idProye" id="idProye" style="width: 100%">
                              ...
                              ?>
												 ...
												 <div class="form-group">
                          <label class="col-md-2 control-label" style="font-size: 14px">Institución</label>
                          <div class="col-md-10">
                            <select class="form-control js-example-responsive" name="idInst" id="idInst" style="width: 100%">
                              <option>Selecciona la Institución</option>
                              <?php
                                $ConexionBD = new Conexion();
                          ...
                          <div class="col-md-offset-2 col-md-10">
                            <button class="btn btn-success" type="submit" id="Asignacion" name="Asignacion">Registrar Asignacion Proyecto - Institución</button>
                          </div>
                        </div>
											</form>
                    </div>
