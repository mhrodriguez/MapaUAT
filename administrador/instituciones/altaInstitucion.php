...
<html>
  <head>
    <meta charset="utf-8">
    <title>Alta de Instituciones UPV</title>
          ...
          <div class="col-xs-12 col-sm-9 content">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title"><a href="javascript:void(0);" class="toggle-sidebar"><span class="fa fa-angle-double-left" data-toggle="offcanvas" title="Maximize Panel"></span></a> Instituciones</h3>
              </div>
              <!--inicio del cuerpo-->
                ...
                <div class="content-row">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading" style="background-color: #FF6400;">
                      <div class="panel-title" style="color:white; text-align: center; font-size: 20px"><b>Alta de Institucion</b>
                      </div>
                    ...
                    <div class="panel-body">
                      <form action="procesar_AltaInstitucion.php" method="POST" role="form" class="form-horizontal">
                        <div class="form-group">
                          <label class="col-md-2 control-label" style="font-size: 14px">Nombre:</label>
                          <div class="col-md-10">
                            <input type="text" required placeholder="Nombre de la Institucion" id="nombreI" class="form-control" name="nombreI">
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="col-md-offset-2 col-md-10">
                            <button class="btn btn-success" type="submit">Registrar Institucion</button>
                          </div>
                        </div>
                      </form>
                    </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
            <h3>Contactanos</h3>
            <ul>
              <li>Twittea con nosotros <a href="https://twitter.com" target="_blank">@BrayantSangines</a>&nbsp;&nbsp;&nbsp;&nbsp;Email de Contacto <span class="connect">contacto@upv.edu.mx</span></li>
              <li>
