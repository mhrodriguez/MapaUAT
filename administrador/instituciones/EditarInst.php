<?php
  ...
  $select = "SELECT nombre FROM INSTITUCION WHERE id = '$id'";
                ...
                <div class="content-row">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading" style="background-color: #FF6400;">
                      <div class="panel-title" style="color:white; text-align: center; font-size: 20px"><b>Editar Datos de Institución</b>
                      </div>
                    ...
                    <div class="panel-body">
                      <form action="Procesar_EditarInst.php?id=<?=$id?>" method="POST" role="form" class="form-horizontal">
                        <div class="form-group">
                          <label class="col-md-2 control-label" style="font-size: 14px">Nombre:</label>
                          <div class="col-md-10">
                            <input type="text" required id="nombreI" class="form-control" name="nombreI" value="<?=$Nombre?>">
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="col-md-offset-2 col-md-10">
                            <button class="btn btn-success" type="submit">Actualizar Institución</button>
                          </div>
                        </div>
                      </form>
                    </div>
