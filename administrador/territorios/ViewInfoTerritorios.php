...
<html>
  <head>
    <meta charset="utf-8">
    <title>Vista Informacion Territorios</title>
      ...
      $(document).ready(function(){
          $('#InfoTerritorios').DataTable();
			...
			function Eliminar(id){
				...
				text: "Cuando se elimina un Territorio se pierden todos los datos almacenados!",
				type: 'warning',
				showCancelButton: true,
				confirmButtonColor: '#3085d6',
				cancelButtonColor: '#d33',
				cancelButtonText:'Cancelar',
				confirmButtonText: 'Si, eliminar Territorio!'}).then(function() {
			...
			function Procesar_Eliminar(id){
				...
				$.ajax({
					type:'POST',
					url:"procesar_EliminarTerritorios.php",
					data: {opcion:opcion,id:id},
					success:function(respuesta){
						swal('Territorio Eliminado!',
							'El Territorio fue eliminada exitosamente.',
                ...
                <div class="content-row">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading" style="background-color: #A96317;">
                      <div class="panel-title" style="color:white; text-align: center; font-size: 20px"><b>Listado de Territorio</b>
                      </div>
                    ...
                    <div class="panel-body">
                          <div class="table-responsive">
                            <table class="table display table table-striped table-bordered datatable" id="InfoTerritorios" cellspacing="0" width="100%">
                              <thead>
                                <tr>
                                  <th style=" text-align: center; ">Id Territorio</th>
                              ...
                              <tbody>
                                  ...
                                  foreach ($ConexionBD -> query($select) as $resultado){//imprime los valores 
                                    ...
                                    echo "<td style=' text-align: center; '>".$resultado["latitud"]."</td>";
                                    echo "<td style=' text-align: center; '>".$resultado["longitud"]."</td>";
                                    echo "<td style=' text-align: center; '>"."<a href='EditarTerritorios.php?id=$resultado[id]'><button class='btn btn-success ' border: none;'>Editar</button></a>"."</td>";
