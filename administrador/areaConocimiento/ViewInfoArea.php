      ...
      $(document).ready(function(){
          $('#InfoTerritorios').DataTable();
			...
			function Eliminar(id){
				swal({
				title: 'Seguro que Quieres Eliminar el Area de Conocimiento?',
				text: "Cuando se elimina el Area de Conocimiento se pierden todos los datos almacenados!",
				type: 'warning',
				showCancelButton: true,
				confirmButtonColor: '#3085d6',
				cancelButtonColor: '#d33',
				cancelButtonText:'Cancelar',
				confirmButtonText: 'Si, eliminar Area de Conocimiento!'}).then(function() {
			...
			function Procesar_Eliminar(id){
				...
				$.ajax({
					type:'POST',
					url:"Procesar_EliminarArea.php",
					data: {opcion:opcion,id:id},
					success:function(respuesta){
						swal('Area de Conocimiento Eliminada!',
							'El Area de Conocimiento fue eliminada exitosamente.',
                ...
                <div class="content-row">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading" style="background-color: #FF6400;">
                      <div class="panel-title" style="color:white; text-align: center; font-size: 20px"><b>Listado de Areas</b>
                      </div>
                    ...
                    <div class="panel-body">
                          <div class="table-responsive">
                            <table class="table display table table-striped table-bordered datatable" id="InfoTerritorios" cellspacing="0" width="100%">
                              <thead>
                                <tr>
                                  <th style=" text-align: center; ">Id Area de Conocimiento</th>
                              ...
                              <tbody>
                                  ...
                                  foreach ($ConexionBD -> query($select) as $resultado){//imprime los valores 
                                    ...
                                    echo "<td style=' text-align: center; '>"."<a href='EditarArea.php?id=$resultado[id]'><button class='btn btn-success ' border: none;'>Editar</button></a>"."</td>";
