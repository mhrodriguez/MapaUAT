...
<html>
  <head>
    <meta charset="utf-8">
    <title>Alta de Area de conocimiento UPV</title>
                ...
                <div class="content-row">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading" style="background-color: #FF6400;">
                      <div class="panel-title" style="color:white; text-align: center; font-size: 20px"><b>Alta de Area de Conocimiento</b>
                      </div>
                    ...
                    <div class="panel-body">
                      <form action="procesar_altaArea.php" method="POST" role="form" class="form-horizontal">
                        <div class="form-group">
                          <label class="col-md-2 control-label" style="font-size: 14px">Nombre:</label>
                          <div class="col-md-10">
                            <input type="text" required placeholder="Nombre del Area de Conocimiento" id="nombreAC" class="form-control" name="nombreAC">
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="col-md-offset-2 col-md-10">
                            <button class="btn btn-success" type="submit">Registrar Area de Conocimiento</button>
                          </div>
                        </div>
                      </form>
                    </div>
