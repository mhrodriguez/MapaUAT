...
<html>
  <head>
    <meta charset="utf-8">
    <title>Vista Informacion Responsables</title>
      ...
      $(document).ready(function(){
          $('#InfoTerritorios').DataTable();
			...
			function Eliminar(id){
				swal({
				title: 'Seguro que Quieres Eliminar este Responsable?',
				text: "Cuando se elimina un Responsable se pierden todos los datos almacenados!",
				type: 'warning',
				showCancelButton: true,
				confirmButtonColor: '#3085d6',
				cancelButtonColor: '#d33',
				cancelButtonText:'Cancelar',
				confirmButtonText: 'Si, eliminar Responsable!'}).then(function() {
			...
			function Procesar_Eliminar(id){
				...
				$.ajax({
					type:'POST',
					url:"Procesar_EliminarResp.php",
					data: {opcion:opcion,id:id},
					success:function(respuesta){
						swal('Responsable Eliminado!',
							'El Responsable fue eliminado exitosamente.',
                ...
                <div class="content-row">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading" style="background-color: #A96317;">
                      <div class="panel-title" style="color:white; text-align: center; font-size: 20px"><b>Listado de Responsables</b>
                      </div>
                    ...
                    <div class="panel-body">
                          <div class="table-responsive">
                            <table class="table display table table-striped table-bordered datatable" id="InfoTerritorios" cellspacing="0" width="100%">
                              <thead>
                                <tr>
                                  <th style=" text-align: center; ">Id Responsable</th>
                              ...
                              <tbody>
                                  <?php
                                   ...
                                   $select ="SELECT * FROM RESPONSABLE";
                                  foreach ($ConexionBD -> query($select) as $resultado){//imprime los valores 
																		echo "<tr>";
                                    echo "<td style=' text-align: center; '>".$resultado["id"]."</td>";
                                    echo "<td style=' text-align: center; '>".$resultado["full_name"]."</td>";
                                    echo "<td style=' text-align: center; '>"."<a href='EditarResp.php?id=$resultado[id]'><button class='btn btn-success ' border: none;'>Editar</button></a>"."</td>";
